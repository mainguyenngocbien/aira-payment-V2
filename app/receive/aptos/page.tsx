        ...
        <div className="max-w-md mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-lg font-bold text-gray-900">On-Chain Aptos Deposit</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="card bg-white shadow-lg border-0">
          <div className="card-body p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">Aptos</h4>
                <p className="text-sm text-gray-600">On-Chain Aptos Wallet</p>
              </div>
            </div>
          </div>
        </div>
