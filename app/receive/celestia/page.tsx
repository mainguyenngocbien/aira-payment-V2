        ...
        <div className="max-w-md mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-lg font-bold text-readable-primary">On-Chain Celestia Deposit</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="card bg-white shadow-lg border-0">
          <div className="card-body p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-semibold text-readable-primary">Celestia</h4>
                <p className="text-sm text-readable-secondary">On-Chain Celestia Wallet</p>
              </div>
            </div>
          </div>
        </div>
