...
export default function SuiDepositPage() {
  ...
  useEffect(() => {
    const getWallet = async () => {
      ...
      try {
        ...
        setSuiAddress(walletInfo.suiWallet);
        setLoading(false);
      } catch (err) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="max-w-md mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-lg font-bold text-gray-900">On-Chain SUI Deposit</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-md mx-auto px-4 py-6 space-y-6">
          ...
          <div className="card-body p-6">
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                <code className="flex-1 text-sm font-mono break-all">{suiAddress}</code>
                <button 
        ...
        <div className="alert alert-warning shadow-lg">
          ...
          <span>Only send SUI tokens to this address</span>
        </div>
        ...
        <div className="card bg-white shadow-lg border-0">
          <div className="card-body p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">SUI</h4>
                <p className="text-sm text-gray-600">On-Chain SUI Wallet</p>
              </div>
            </div>
          </div>
        </div>
