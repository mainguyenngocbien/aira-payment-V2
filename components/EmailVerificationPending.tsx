      ...
      <div className="max-w-md w-full">
          ...
          <div className="card-body p-6">
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-10 h-10 bg-base-200 rounded-full flex items-center justify-center">
                <Mail className="w-5 h-5 text-[#044aad]" />
              </div>
              <div>
                <p className="font-medium text-[#044aad]">{user.email}</p>
                <p className="text-sm text-[#044aad]">Check your inbox</p>
              </div>
            </div>
        ...
        <div className="text-center">
          <button
            ...
            className="btn btn-ghost btn-sm text-[#044aad] hover:text-[#044aad]"
          >
        ...
        <div className="mt-8 text-center">
          <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
            <h3 className="text-sm font-medium text-[#044aad] mb-2">Need Help?</h3>
            <div className="text-xs text-[#044aad] space-y-1">
